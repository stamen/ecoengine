...
ECO.endpoints = {
  ...
  reserves: 'https://ecoengine.berkeley.edu/api/layers/reserves/features/?ordering=name',
  jepson: 'https://ecoengine.berkeley.edu/api/layers/jepson-regions/features/?ordering=name'
};
